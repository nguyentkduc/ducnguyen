...
togglePlayer.addEventListener("click", function() {
    ...
    if(isHidden){
        ...
        togglePlayer.innerHTML = '<img class="w-[98%]" src="E:/html/emLinh/icons/close.svg">';
        trackInfo.style.transitionDelay = "0.4s";
        trackNav.style.transitionDelay = "0.4s";
    } else {
        musicPlayer.classList.add("hide");
        togglePlayer.innerHTML = '<img class="w-full" src="E:/html/emLinh/icons/plus.svg">';
...
let trackList = [
    {
        name: "Only",
        artist: "Lee Hi",
        path: "E:/html/emLinh/music/only.mp3",
    },
    {
        name: "Day & Night",
        artist: "Jung Seung Hwan",
        path: "E:/html/emLinh/music/music_day and night.mp3",
    },
    {
        name: "Love of my Life",
        artist: "Reyne",
        path: "E:/html/emLinh/music/love of my life.mp3",
    },
    {
        name: "The Only One",
        artist: "Reyne",
        path: "E:/html/emLinh/music/the only one.mp3",
    },
];
...
function playTrack(){
    currentTrack.play();
    isPlaying = true;
    playPauseBtn.innerHTML = '<img class="w-8" src="emLinh/icons/pause.svg">';
...
function pauseTrack(){
    currentTrack.pause();
    isPlaying = false;
    playPauseBtn.innerHTML = '<img class="w-8" src="E:/html/emLinh/icons/play.svg">';
